...
#Clip the gfa path for the bed regions. The reference path is not clipped but create the integrated new nodes for the clipped regions.
#python3 gfa_bed_filter.py input.gfa input.bed ref.samples output.gfa
