...
#Levarage pangenoem to annotate the variant based on variant content or flanking content
#python3 graph_vcf_biallelic_annotate.py input.vcf input.anno output.content.anno output.flanking.anno
...
for line in vcf_file:
    if line[0:1] == "#":
        ...
        if "ID" not in info_dict or "AT" not in info_dict:
            continue
