...
#Detect the nested variant by founding the snarls not traversed by the reference allele
#python3 graph_vcf_nest_detection.py input.vcf input.gfa input.snarls.txt input.nest.vcf
