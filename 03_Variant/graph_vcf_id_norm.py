...
#Add ID information for the variant sites from vcf generated by graph_vcf_vt_annotate.py
#python3 graph_vcf_id_norm.py input.vcf > output.vcf
...
for line in vcf_file:
    if line[0:2] == "##":
        ...
        print('##INFO=<ID=ID,Number=1,Type=String,Description="Bubble ID">')
        print(line, end="")
    else:
