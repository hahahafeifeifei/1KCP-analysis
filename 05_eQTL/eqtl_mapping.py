...
expression_bed = '1kcp_Counts_TMM_RINT_AdjCov_60PEER.residuals.rint.bed'
covariates_file = '1kcp.covariates.txt'
prefix = sys.argv[2]
...
indep_df.to_csv(prefix + ".cond.eqtl.gene.txt",index=False,sep="\t")
...
cis_df.to_csv(prefix + ".eqtl.gene.txt",index=False,sep="\t")
